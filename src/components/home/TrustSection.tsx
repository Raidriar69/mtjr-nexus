  ...
  const features = [
    {
      ...
      descKey:  'home.feature1Desc'  as const,
    ...
    },
    {
      ...
      descKey:  'home.feature2Desc'  as const,
      color: 'text-cyan-400',
    },
    {
      icon: (
      ...
      descKey:  'home.feature3Desc'  as const,
    ...
    },
    {
      ...
      titleKey: 'home.feature4Title' as const,
      descKey:  'home.feature4Desc'  as const,
    ...
    <section className="py-20 bg-[#0d0d15]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 max-w-lg mx-auto">{t('home.whyBuyDesc')}</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((f) => (
            ...
            >
              ...
              <h3 className="text-white font-semibold mb-2">{t(f.titleKey)}</h3>
